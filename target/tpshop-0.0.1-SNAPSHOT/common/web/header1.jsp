...
<%--                        class="icon-bar"></span>--%>
                ...
                <div class="logo">
                    <h1>
                        <a href='<c:url value="/"/>'><span>MN</span> -Shop</a>
                    </h1>
                </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <div class="flexbox">
                            <div class="search">
                                ...
                                <div>
                                    <input id="form-search" type="text" placeholder="Tìm kiếm . . ."
                                           required>
                                </div>
                            </div>
                        </div>
                    ...
                    <li><a href='<c:url value="/"/>'>Trang chủ</a></li>
                    <li class="dropdown"><a href="#" class="dropdown-toggle"
                                            data-toggle="dropdown">Nam <b class="caret"></b></a>
                    ...
                    <li><a href='<c:url value="/contact" />'>Liên hệ</a></li>
                    <security:authorize access="isAnonymous()">
                    ...
                    <security:authorize access="isAuthenticated()">
                        <li class="dropdown"><a href="#"
                            ...
                            <ul class="dropdown-menu"
                                ...
                                <li><a class="nav-link"
                                       href="<c:url value="/user/${SecurityUtils.getPrincipal().getUserId()}"/>">Thông
                                    tin</a></li>
                                <li><a class="nav-link"
                                       href="<c:url value="/user/bill?userId=${SecurityUtils.getPrincipal().getUserId()}"/>">Đơn
                                    hàng</a></li>
                                <li><a class="nav-link"
                            ...
                            <a href='<c:url value="/giohang/"/>'> <img
                                ...
                                <c:if test="${soluongsanphamgiohang > 0}">
                                    <div class="circle-giohang">
                                        <span value="${soluongsanphamgiohang}"
                                              style="color: white">${soluongsanphamgiohang}</span>
                                    </div>
                                </c:if> <c:if
